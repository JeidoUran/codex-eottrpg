(async () => {
  ...
  async function loadCharacter() {
    ...
    const jsonUrl = `https://s3.codex.eottrpg.memiroa.com/data/archivist/characters/${slug}.json`;
    ...
    if (!res.ok) {
      container.innerHTML = `<p>Erreur lors du chargement de la biographie.</p>`;
      return;
    }
